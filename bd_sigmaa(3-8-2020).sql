...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-08-2020 a las 23:37:23
...
(98765423, 'Maria Eugenia Gomez Ardila', 'maria.gomez@estudiantes.areandina.edu.co', '3213456743', 'activo', 3, 9, 3, '1', 'Presencial'),
(123424323, 'Ivan Zuleta Martinez', 'ivan.zuleta@estudiantes.areandina.edu.co', '3104567484', 'activo', 1, 3, 1, '5', 'Presencial'),
(324543432, 'Falcao Garcia', 'falcao.garcia@estudiantes.areandina.edu.co', '3203712166', 'activo', 2, 8, 2, '1', 'Virtual');
...
(5, '2020-07-28', 10, 'Se revisÃ³ la situaciÃ³n. ', 'foto', 'http://localhost:8080/Projecto_SIGMAA_V02/evidencias/hacker.jpg'),
(6, '2020-07-28', 12, 'Se hablo con el estudiante por vÃ­a whatsapp y se le indicÃ³ que debe estudiar mÃ¡s. ', 'whatsapp', 'http://localhost:8080/Projecto_SIGMAA_V02/evidencias/Recibo de pago II semestre 2020.pdf');
...
(5, '2020-07-27', 4343434, 3, 1, 1, 123456, 'Prueba', 'Cerrado'),
(6, '2020-07-27', 324543432, 2, 1, 2, 54879545, 'El estudiante presenta bajas notas por estar pensando en el football.', 'Cerrado');
...
CREATE TABLE `usuarios` (
  ...
  `Mail_users` varchar(100) CHARACTER SET utf8 NOT NULL,
  `Pass_users` varchar(100) COLLATE utf8_spanish_ci NOT NULL DEFAULT '827ccb0eea8a706c4c34a16891f84e7b',
...
(123456, 'Jose Emilio Gutierrez Padilla', 'jose@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '3203712166', 1, 1, 3, 1, '10', 'Presencial'),
(1977392, 'Omar Martinez Aguilera', 'omar.martinez@estudiantes.areandina.edu.co', '827ccb0eea8a706c4c34a16891f84e7b', '3203712166', 1, 2, 8, 2, '10', 'Virtual'),
(2375435, 'Ruben Dario Andrade Hoyos', 'ruben.andrade@estudiantes.areandina.edu.co', '827ccb0eea8a706c4c34a16891f84e7b', '3203712166', 2, 3, 9, 3, '8', 'Presencial'),
(4343434, 'Mariana Rubiano Marrugo', 'mariana@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '3125232577', 2, 2, 8, 2, '1', 'Presencial'),
(10516932, 'Peregrino Gomez Acosta', 'peregrino.gomez@estudiantes.areandina.edu.co', '827ccb0eea8a706c4c34a16891f84e7b', '3203712166', 1, 1, 3, 1, '1', 'Presencial'),
(10547808, 'Jose Acosta Fausto', 'jose.acosta@areandina.edu.co', '827ccb0eea8a706c4c34a16891f84e7b', '3203712166', 3, 3, NULL, NULL, NULL, NULL),
...
(54879545, 'Andrea Echeverry', 'andrea.echeverry@estudiantes.areandiana.edu.co', '827ccb0eea8a706c4c34a16891f84e7b', '3208742188', 2, 2, 8, 2, '5', 'Virtual'),
(76307332, 'William Efrain Abella Herrera', 'william.abella@areandina.edu.co', '827ccb0eea8a706c4c34a16891f84e7b', '3203712166', 3, 1, NULL, NULL, NULL, NULL),
...
(123456789, 'Administrador del sistema', 'administrador@areandina.edu.co', '827ccb0eea8a706c4c34a16891f84e7b', '3203712166', 4, 0, 8, 0, NULL, NULL);
...
--
ALTER TABLE `tutorias`
  MODIFY `Id_tutorias` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
