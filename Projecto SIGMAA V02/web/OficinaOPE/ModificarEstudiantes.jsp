...
<html>
    <head>
        ...
        <title>Modificar de Estudiantes</title>
                    ...
                    <div class="row justify-content-md-center">                     
                        ...
                        <div class="col-sm-2">
                            <div class="form-group text-center">
                                ...
                                <button value="1" type="submit" name="btnModificarEstudianteOPE" id="btnModificarEstudianteOPE" class="btn btn-outline-primary" data-toggle="tooltip" title="Actualizar el registro"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                <button value="2" type="submit" name="btnEliminarEstudianteOPE" id="btnEliminarEstudianteOPE" class="btn btn-outline-primary" data-toggle="tooltip" title="Eliminar el registro"><i class="fa fa-trash" aria-hidden="true"></i></button>
                            </div> 
                        </div>
                    </div>
                </form>
