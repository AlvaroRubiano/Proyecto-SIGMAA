            ...
            <div class="card-body">
                ...
                <div class="container">
                    <%
                        ...
                        ResultSet rs = null;
                        String consulta = "SELECT programa.Name_program, COUNT(tutorias.Id_tutorias) "
                                + "FROM programa, tutorias "
                                + "WHERE programa.Id_program=tutorias.Id_programa "
                                + "GROUP BY programa.Name_program;";
                        ...
                        try {                            
                            ...
                            while (rs.next()) {
                                data.setValue(rs.getInt(2), rs.getString(1), rs.getString(1)+" ("+rs.getString(2)+")");
                            }
                            JFreeChart grafico = ChartFactory.createBarChart("Registro de Tutorias por Programas", "Programas", "Cantidad", data, PlotOrientation.VERTICAL, true, true, true);
