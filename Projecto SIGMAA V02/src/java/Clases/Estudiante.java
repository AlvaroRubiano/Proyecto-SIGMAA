...
public class Estudiante {
    ...
    public Estudiante(int identificacion, String nombres, String correo, String telefono, String tipo, int id_campus, int id_facultad, int id_programa, String semestre, String modalidad, int materia) {
