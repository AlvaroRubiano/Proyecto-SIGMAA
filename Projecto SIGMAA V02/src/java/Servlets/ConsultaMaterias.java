...
public class ConsultaMaterias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {            
            String consulta = "SELECT materia.Id_clase, materia.Nombre_clase, programa.Name_program, programa.Modalidad, facultad.Name_faculty, campus.Name_campus FROM materia, programa, facultad, campus WHERE materia.Id_programa=programa.Id_program AND programa.Id_faculty=facultad.Id_faculty AND facultad.Id_campus=campus.Id_campus";
