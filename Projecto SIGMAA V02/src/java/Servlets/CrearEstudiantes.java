...
public class CrearEstudiantes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(uno.equals(btn1)){
            try {
            String consultax = "insert into estudiantes (Id_estudiante, Name_users, Mail_users, Phone_users, Estado_usuario, Id_campus, Id_faculty, Id_program, Semestre, Modalidad) values(?,?,?,?,?,?,?,?,?,?)";
