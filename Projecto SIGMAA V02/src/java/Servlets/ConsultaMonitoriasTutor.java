 ...
 * @author Alvaro
 */
public class ConsultaMonitoriasTutor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                String consulta = "SELECT tutorias.Id_tutorias, tutorias.fecha, estudiantes.Name_users, estudiantes.Phone_users, estudiantes.Mail_users, semestre.nombre, factor_asociado.Name_factor, usuarios.Name_users, obervaciones "
