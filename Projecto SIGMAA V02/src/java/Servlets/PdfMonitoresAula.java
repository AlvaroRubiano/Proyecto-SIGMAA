 ...
 * @author Alvaro
 */
public class PdfMonitoresAula extends HttpServlet {
        ...
        try{
            try {
                ...
                try {
                    ...
                    PdfPCell celdaDatoReporte = new PdfPCell(new Phrase("Registro Monitores de Aula", FontFactory.getFont("Arial",10, Font.NORMAL, BaseColor.BLACK)));
