 ...
 */
public class ConsultaCampus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String consulta = "SELECT Id_campus, Name_campus, Tipo, Direccion FROM campus";
            ...
            while(rs.next()){
                ...
                item.addProperty("identificador", rs.getInt("Id_campus"));
                item.addProperty("nombre", rs.getString("Name_campus"));
