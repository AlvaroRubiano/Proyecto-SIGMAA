 ...
 */
public class SeleccionaPrograma extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for(Programas c : gm.getProgramas(idFacultad)){            
            htmlcode2 += c.getId_programa()+ " - " + c.getNombre_Programa()+ " - " +c.getModalidad()+":";            
        }        
