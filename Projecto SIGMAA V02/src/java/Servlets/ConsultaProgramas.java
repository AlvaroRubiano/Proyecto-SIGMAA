...
public class ConsultaProgramas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {            
            String consulta = "SELECT programa.Id_program, programa.Name_program, programa.Modalidad, campus.Name_campus, facultad.Name_faculty FROM programa, campus, facultad WHERE programa.Id_program=facultad.Id_faculty AND facultad.Id_campus=campus.Id_campus";
            ...
            while(rs.next()){
                ...
                item.addProperty("identificador", rs.getString("programa.Id_program"));
                item.addProperty("nombre", rs.getString("programa.Name_program"));
