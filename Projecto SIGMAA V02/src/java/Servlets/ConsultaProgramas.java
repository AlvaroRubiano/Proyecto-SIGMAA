...
public class ConsultaProgramas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {            
            String consulta = "SELECT programa.Id_program, programa.Name_program, programa.Modalidad, campus.Name_campus, faculta.Name FROM programa, campus, faculta WHERE programa.Id_faculty=faculta.Id AND faculta.IdCampus=campus.Id_campus;";
