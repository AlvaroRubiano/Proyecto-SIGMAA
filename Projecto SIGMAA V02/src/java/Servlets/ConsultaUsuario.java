...
public class ConsultaUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String consulta = "SELECT usuarios.Id_usuario, usuarios.Name_users, usuarios.Mail_users, usuarios.Phone_users, usuarios.Type_users, campus.Name_campus, facultad.Name_faculty, programa.Name_program, usuarios.Semestre, usuarios.Modalidad FROM usuarios, campus, facultad, programa WHERE usuarios.Id_campus = campus.Id_campus AND facultad.Id_faculty=usuarios.Id_faculty AND programa.Id_program=usuarios.Id_program";
            ...
            while(rs.next()){
                ...
                item.addProperty("tipo", rs.getString("usuarios.Type_users"));
