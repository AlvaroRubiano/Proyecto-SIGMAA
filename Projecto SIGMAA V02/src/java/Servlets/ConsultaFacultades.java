 ...
 */
public class ConsultaFacultades extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String consulta = "SELECT facultad.Id_faculty, facultad.Name_faculty, campus.Name_campus FROM facultad, campus WHERE campus.Id_campus=facultad.Id_campus";
            ...
            while(rs.next()){
                ...
                item.addProperty("identificador", rs.getString("facultad.Id_faculty"));
                item.addProperty("nombre", rs.getString("facultad.Name_faculty"));
