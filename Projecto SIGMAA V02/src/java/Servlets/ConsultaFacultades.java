...
public class ConsultaFacultades extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String consulta = "SELECT faculta.Id, faculta.Name, campus.Name_campus FROM faculta, campus WHERE campus.Id_campus=faculta.IdCampus";
            ...
            while(rs.next()){
                ...
                item.addProperty("identificador", rs.getString("faculta.Id"));
                item.addProperty("nombre", rs.getString("faculta.Name"));
