...
public class ConsultaEstudiantes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String consulta = "SELECT estudiantes.Id_estudiante, estudiantes.Name_users, estudiantes.Mail_users, estudiantes.Phone_users, estudiantes.Estado_usuario, campus.Name_campus, facultad.Name_faculty, programa.Name_program, estudiantes.Semestre, estudiantes.Modalidad FROM estudiantes, campus, facultad, programa WHERE estudiantes.Id_campus = campus.Id_campus AND facultad.Id_faculty=estudiantes.Id_faculty AND programa.Id_program=estudiantes.Id_program;";
