...
public class ConsultaEstudiantes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String consulta = "Select estudiantes.Id_estudiante, estudiantes.Name_users, estudiantes.Mail_users, estudiantes.Phone_users, estudiantes.Type_users, campus.Name_campus, facultad.Name_faculty, programa.Name_program, estudiantes.Semestre, estudiantes.Modalidad, materia.Nombre_clase from estudiantes, campus, facultad, programa, materia where estudiantes.Id_campus=campus.Id_campus and estudiantes.Id_faculty=facultad.Id_faculty and estudiantes.Id_program=programa.Id_program and estudiantes.Id_clase=materia.Id_clase";
            ...
            while(rs.next()){
                ...
                item.addProperty("tipo", rs.getString("estudiantes.Type_users"));
                ...
                item.addProperty("materia", rs.getString("materia.Nombre_clase"));
