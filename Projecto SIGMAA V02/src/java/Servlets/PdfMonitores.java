 ...
 */
public class PdfMonitores extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            try {
                String consulta = "SELECT usuarios.Name_users, tipotutor.nombre, COUNT(tutorias.Id_tutorias) FROM tutorias, usuarios, tipotutor WHERE tutorias.Id_tutor=usuarios.Id_usuario AND usuarios.Type_users=tipotutor.Id_tipo AND tutorias.estado=\"Cerrado\" GROUP BY usuarios.Name_users";
                ...
                try {
                    ...
                    PdfPCell celdaDatoReporte = new PdfPCell(new Phrase("Registro de Atención de Monitorias Realizadas por grupo", FontFactory.getFont("Arial",10, Font.NORMAL, BaseColor.BLACK)));
                    ...
                    PdfPCell celdaTipo = new PdfPCell(new Phrase("REALIZADAS", FontFactory.getFont("Arial",8, Font.NORMAL, BaseColor.BLACK)));
